      ...
      <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div className="space-y-6 lg:col-span-2">
            <div className="relative h-48 overflow-hidden bg-gray-100 sm:h-64">
          ...
          <div className="space-y-4">
            ...
            <div className="border border-gray-100 bg-white p-5 shadow-sm">
              ...
              <div className="overflow-hidden border border-[#0D2E6B]/10 bg-[#EDF1F9]">
            ...
            <div className="bg-[#0D2E6B] p-5 text-white">
